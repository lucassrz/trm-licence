<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <form action="{{ route('groupes') }}" method="GET">
                <div class="mb-3 xl:w-96">
                    <div class="input-group relative flex items-stretch w-full mb-4 rounded">
                        <input value="{{ app('request')->input('s') }}" type="search" name="s" class="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Rechercher un groupe">
        ...
        <div>
            <a class="p-2 bg-gray-500 hover:bg-gray-700 text-white font-bold rounded" href="{{ route('groupes/form') }}">{{ __('other.add_groupe') }}</a>
        </div>
    </x-slot>
                ...
                <div class="overflow-hidden">
                    <table class="min-w-full mb-3">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">
                                @sortablelink('updated_at', "Date de mise à jour")
                            </th>
                        </tr>
                        </thead>
                        <tbody>
