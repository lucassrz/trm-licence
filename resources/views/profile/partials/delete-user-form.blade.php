<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Une fois votre compte supprimé, toutes les ressources et données associées seront supprimées. Avant de supprimer votre compte, veuillez télécharger les données ou informations que vous souhaitez garder.') }}
        </p>
    </header>
